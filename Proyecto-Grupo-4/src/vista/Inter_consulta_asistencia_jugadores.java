...
public class Inter_consulta_asistencia_jugadores extends javax.swing.JInternalFrame {
    ...
    int id;
    public Inter_consulta_asistencia_jugadores(){
        initComponents();
        listar();
        combo_buscar();
    }
    void listar(){
        ...
        try{
            ...
            modelo=(DefaultTableModel)table_jugadores.getModel();
            while(rs.next()){
                jugadores[0] =contador++;
                jugadores[1]=rs.getInt("Id");
                jugadores[2]=rs.getString("Nombres");
                jugadores[3]=rs.getString("Apellidos");
                jugadores[4]=rs.getString("Nacionalidad");
                jugadores[5]=rs.getString("Equipo");
                modelo.addRow(jugadores);
            }
            table_jugadores.setModel(modelo);
        }
        catch(Exception e){
    ...
    void limpiarFiltros() {
        ...
        text_field_buscar_jugadores.setText(""); // Limpia el JTextField de búsqueda
        modelo.setRowCount(0);
        listar(); // Vuelve a mostrar todos los registros en la tabla
    }
    
    private void buscarJugadores(String filtro, String valor) {
        String sql = "SELECT * FROM jugadores WHERE " + filtro + " LIKE '%" + valor + "%'";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al buscar jugadores", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        table_jugadores_asistencia = new javax.swing.JTable();
        combo_box_buscar = new javax.swing.JComboBox<>();
        lbl_advice = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        text_field_buscar_jugadores = new javax.swing.JTextField();
        btnLimpiar = new javax.swing.JButton();
        btnBuscar_jugadores = new javax.swing.JButton();
        jLabel15 = new javax.swing.JLabel();

        setClosable(true);
        setResizable(true);
        setTitle("Asistencia jugadores");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 180, -1));
        ...
        table_jugadores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "ID", "Nombres", "Apellidos", "Nacionalidad", "Equipo"
            }
        ) {
        ...
        jScrollPane1.setViewportView(table_jugadores);
        ...
        table_jugadores_asistencia.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(table_jugadores_asistencia);
        ...
        combo_box_buscar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Id", "Apellidos", "Nacionalidad", "Equipo" }));
        ...
        lbl_advice.setText("Seleccione un jugador para visualizar su historial de asistencias *");
        ...
        text_field_buscar_jugadores.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                text_field_buscar_jugadoresKeyPressed(evt);
            }
        });
        jPanel1.add(text_field_buscar_jugadores, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 170, -1));
        ...
        btnBuscar_jugadores.setBackground(new java.awt.Color(0, 255, 102));
        btnBuscar_jugadores.setFont(new java.awt.Font("Cambria", 1, 16)); // NOI18N
        btnBuscar_jugadores.setText("Buscar");
        btnBuscar_jugadores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscar_jugadoresActionPerformed(evt);
            }
        });
        jPanel1.add(btnBuscar_jugadores, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, 90, 30));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/utea.png"))); // NOI18N
        jLabel15.setOpaque(true);
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 830, 500));
        ...
        getAccessibleContext().setAccessibleName("Asistencia jugadores");
    ...
    void combo_buscar(){
        ...
        if (filtroSeleccionado.equals("Seleccionar")) {
            text_field_buscar_jugadores.setEnabled(false); // Deshabilita la edición del JTextField
            btnBuscar_jugadores.setEnabled(false); // Deshabilita el botón de búsqueda
            modelo.setRowCount(0);
            listar(); // Llama nuevamente a listar() para mostrar todos los registros
        } else {
            modelo.setRowCount(0);
            listar(); // Llama nuevamente a listar() para mostrar todos los registros
            text_field_buscar_jugadores.setEnabled(true); // Habilita la edición del JTextField
            btnBuscar_jugadores.setEnabled(true); // Habilita el botón de búsqueda
        }
    }
    ...
    private void btnBuscar_jugadoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscar_jugadoresActionPerformed
        String filtroSeleccionado = combo_box_buscar.getSelectedItem().toString();
        String valorBusqueda = text_field_buscar_jugadores.getText().trim();
    
        if (!filtroSeleccionado.equals("Seleccionar") && !valorBusqueda.isEmpty()) {
            buscarJugadores(filtroSeleccionado, valorBusqueda);
        } else {
    ...
    }//GEN-LAST:event_btnBuscar_jugadoresActionPerformed

    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        limpiarFiltros();
    }//GEN-LAST:event_btnLimpiarActionPerformed

    private void text_field_buscar_jugadoresKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_field_buscar_jugadoresKeyPressed
        if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
        btnBuscar_jugadoresActionPerformed(null); // Llama al método de búsqueda
        }        
    }//GEN-LAST:event_text_field_buscar_jugadoresKeyPressed

    

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnBuscar_jugadores;
    ...
    private javax.swing.JTable table_jugadores_asistencia;
    private javax.swing.JTextField text_field_buscar_jugadores;
